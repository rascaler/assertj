...
//    }
    ...
    public void testException() {
        assertThat(1).isLessThan(1).thenFailThrow("1000");
    }

    @Test
    public void testExceptionWithLog() {
        // 无占位符
        assertThat(1).isLessThan(1).thenFailWithLogThrow("1000","日志测试");
    }

    @Test
    public void testExceptionWithLog2() {
        // 有占位符
        assertThat(1).isLessThan(1).thenFailWithLogThrow("1000","日志测试[{}]", "占位符");
    }
}
